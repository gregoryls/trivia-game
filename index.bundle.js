...
function getQuestionData() {
  papaparse__WEBPACK_IMPORTED_MODULE_0___default().parse("../src/questions/Trivia - Questions.csv", {
    ...
    complete(results) {
      ...
      (0,_board__WEBPACK_IMPORTED_MODULE_1__["default"])(42);
