...
const getQuestionData = (() => {
  ...
  const csvParse = (csvFile) => {
    papaparse__WEBPACK_IMPORTED_MODULE_1__.Papa.parse(csvFile.files[0], {
      download: true,
