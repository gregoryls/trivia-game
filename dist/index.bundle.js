...
const getQuestionData = (() => {
  ...
  const csvParse = (csvFile) => {
    papaparse__WEBPACK_IMPORTED_MODULE_1___default().parse("questions/Trivia - Questions.csv", {
      download: true,
